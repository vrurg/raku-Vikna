...
=head3 L<C<Vikna::Screen>|https://github.com/vrurg/raku-Vikna/blob/v0.0.3/docs/md/Vikna/Screen.md> C<$.screen>
...
Method must construct and return a L<C<Vikna::Screen>|https://github.com/vrurg/raku-Vikna/blob/v0.0.3/docs/md/Vikna/Screen.md> object to initialize C<$.screen>. See
...
L<C<Vikna::EventEmitter>|https://github.com/vrurg/raku-Vikna/blob/v0.0.3/docs/md/Vikna/EventEmitter.md>
